...
def format_first_contact() -> str:
    return (
        ...
        "• Вы когда-нибудь замечали, что ваш день часто проходит будто бы без вашего участия?\n"
        "• Словно вы фоновый персонаж в чьем-то чужом фильме?\n"
...
def format_onboarding_final_message() -> str:
    return (
        "Анализ завершен.\n"
        "В вас зафиксирован сильный потенциал <b>субъекта</b>.\n\n"
