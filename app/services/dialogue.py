...
async def build_onboarding_conclusion(
    ...
    *,
    ...
    fallback = (
        ...
        "Нажимайте на кнопку снизу и следуйте указаниям. Ждём вас в системе ETHOS!"
    )
    try:
            ...
            [
                {
                    ...
                    "content": (
                        ...
                        "В конце напиши: Нажимайте на кнопку снизу и следуйте указаниям. Ждём вас в системе ETHOS! "
