...
def format_first_contact() -> str:
    return (
        ...
        "Оракул не будет утешать вас красивыми словами. Но он будет вас зеркалить. Он проанализирует, где вы действительно выбираете, а где продолжаете жить на автомате.\n\n"
