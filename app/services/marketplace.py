...
SEED_ITEMS = [
    {
        ...
        "description": (
            "Эффект: повышает осознанность владельца на 10%.\nПервая искра в темноте автопилота."
        ),
        "price_tokens": 10,
    ...
    },
    {
        ...
        "description": (
            "Эффект: увеличивает невозмутимость в психологических баттлах на 20%.\n"
            "Магический огонь, который не гаснет даже под давлением."
        ),
        "price_tokens": 35,
        "item_type": "collectible",
    ...
    },
    {
        ...
        "description": (
            "Эффект: открывает +25% к радикальной честности.\n"
            "Волшебное зеркало, в котором виднеется настоящее «я»."
        ),
        "price_tokens": 90,
        "item_type": "collectible",
    ...
    },
    {
        ...
        "description": (
            "Эффект: увеличивает мудрость владельца на 40%.\n"
            "Холодный серебряный перстень для тех, кто выбирает путь, а не дрейф."
        ),
        "price_tokens": 220,
        "item_type": "collectible",
    ...
    },
    {
        "title": "🦊 Золотой Лис",
        "description": (
            "Эффект: увеличивает эмпатию владельца на 30%.\n"
            "Статуэтка лиса, напоминающая: хитрость без сердца становится манипуляцией."
        ),
        "price_tokens": 540,
        "item_type": "collectible",
    ...
    },
    {
        ...
        "description": (
            "Эффект: делает владельца почти прозрачным для самообмана.\n"
            "Редкий артефакт для тех, кто выдерживает собственную правду без бегства."
        ),
        "price_tokens": 999,
        "item_type": "collectible",
